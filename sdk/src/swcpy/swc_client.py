...
class SWCClient:
    ...
    GET_COUNTS_ENDPONT = "/v0/counts/"
    
    BULK_FILE_BASE_URL = (
        "https://raw.githubusercontent.com/javierpachas"
    ...
    def call_api(self,
            ...
            try:
                with httpx.Client(base_url=self.swc_base_url) as client:
                    logger.debug(f"base_url: {self.swc_base_url}, api_endpoints: {api_endpoint}, api_params: {api_params}")
    ...
    def get_health_check(self) -> httpx.Response:
        ...
        Returns:
            An httpx.Response  object that containts the HTTP status,
